...
@Import({LoginController.class, RegisterController.class, PinController.class, UserController.class, VendorController.class, FoodMenuController.class, FoodMenuService.class, FoodItemController.class, PlayerController.class})
